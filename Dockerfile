...
LABEL "com.github.actions.name"="Automated version bump for python packages."
LABEL "com.github.actions.description"="Automated version bump for python packages."
